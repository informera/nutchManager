 ...
 */
package de.informera.dev.nutchManager.thirdParty;
...
import de.informera.dev.nutchManager.thirdParty.RegexRule;
import de.informera.dev.nutchManager.thirdParty.RegexURLFilterBase;
...
public class RegexURLFilter extends RegexURLFilterBase {
	...
	//TODO: This one is from me!
	public RegexURLFilter(File file)
			throws IOException, PatternSyntaxException {
		super(file);
	}
